...
public class FCMNotificationService {
    ...
    @Autowired
    public FCMNotificationService(FirebaseMessaging firebaseMessaging, UserRepository userRepo) {
    ...
    public String sendNotificationByToken(FCMNotificationRequestDto requestDto) {
        ...
        Optional<User> user = userRepo.findById(requestDto.getTargetUserId());
